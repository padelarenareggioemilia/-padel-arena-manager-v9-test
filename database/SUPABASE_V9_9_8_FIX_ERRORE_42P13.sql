...
-- ============================================================
-- V9.9.8 FIX 42P13
-- Rimuove le vecchie firme incompatibili prima della ricreazione.
-- ============================================================

drop function if exists public.captain_update_team_notes(uuid,text) cascade;
drop function if exists public.captain_update_player_sport_data(uuid,uuid,text,date) cascade;
drop function if exists public.captain_update_player_complete(uuid,uuid,jsonb) cascade;
drop function if exists public.captain_add_player_complete(uuid,jsonb) cascade;
drop function if exists public.captain_get_player_card(uuid) cascade;
drop function if exists public.captain_appoint_secretary(uuid,text) cascade;
drop function if exists public.captain_appoint_secretary_v2(uuid,text) cascade;
drop function if exists public.captain_revoke_secretary(uuid,uuid) cascade;
drop function if exists public.captain_get_team_hub(uuid) cascade;
drop function if exists public.captain_send_team_message(uuid,text) cascade;
drop function if exists public.captain_create_callup(uuid,uuid,uuid[],text,timestamptz) cascade;
drop function if exists public.player_get_team_hub() cascade;
drop function if exists public.player_reply_callup(uuid,text) cascade;
