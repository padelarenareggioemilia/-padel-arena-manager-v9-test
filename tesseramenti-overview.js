...
function addShortcuts(){
 ...
 const a=document.createElement('div');a.className='pam-shortcut';a.id='pamTessShortcut';a.onclick=()=>location.href='admin-tesseramenti.html?v=9968';a.innerHTML='<div class="pam-shortcut-icon">💳</div><div><b>Gestione Tesseramenti</b><span>Richieste pagamento, ricevute e invio AICS</span></div>';
 const b=document.createElement('div');b.className='pam-shortcut';b.onclick=()=>location.href='situazione-tesseramenti.html?v=9968';b.innerHTML='<div class="pam-shortcut-icon">📋</div><div><b>Situazione Tesseramenti</b><span>Controllo di tutte le squadre</span></div>';
 dash.append(a,b);
}
async function load(){
 try{
  ...
  card.innerHTML=`<div class="tess-head"><div><h2>💳 Situazione tesseramenti</h2><div style="color:#627b97">Controllo rapido di tutte le squadre</div></div><button class="tess-btn secondary" onclick="location.href='situazione-tesseramenti.html?v=9968'">Apri situazione completa</button></div>
  ...
  <div class="tess-actions"><button class="tess-btn" onclick="location.href='admin-tesseramenti.html?v=9968'">Gestisci tesseramenti</button><button class="tess-btn secondary" onclick="location.href='situazione-tesseramenti.html?v=9968'">Dettaglio per squadra</button></div>`;
